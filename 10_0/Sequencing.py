...
if str(nbParts) == str(1) :
    ...
    NearTableS = arcpy.GenerateNearTable_analysis(SPt, OutPt, "NearTable", "", "LOCATION", "NO_ANGLE", "")
    rows = arcpy.SearchCursor(NearTableS)
    line = rows.next()
    dS = line.NEAR_DIST
    
    NearTableE = arcpy.GenerateNearTable_analysis(EPt, OutPt, "NearTable", "", "LOCATION", "NO_ANGLE", "")

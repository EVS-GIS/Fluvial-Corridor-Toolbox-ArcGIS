...
@contact: samuel.dunesme@ens-lyon.fr
          ENS - UMR5600 Environnement Ville Societe
...
arcpy.CalculateField_management(UDPts, "Join_Field", "!OBJECTID!", "PYTHON_9.3", "") 
...
arcpy.CalculateField_management(InputFCMTS, "Order_ID", "0", "PYTHON_9.3", "")
...
if str(nbParts) == str(1) :
    ...
    arcpy.CalculateField_management(InputFCMTS, "Order_ID", "1", "PYTHON_9.3", "")
    ...
    arcpy.CalculateField_management(BrancheAvale, "Order_ID", "1", "PYTHON_9.3", "")
    ...
    while int(str(C)) > int(0) :
        ...
        arcpy.CalculateField_management(Selection2, "Order_ID", str(n), "PYTHON_9.3", "")
